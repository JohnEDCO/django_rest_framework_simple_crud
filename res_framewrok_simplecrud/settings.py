"""
Django settings for res_framewrok_simplecrud project.
...
ROOT_URLCONF = 'res_framewrok_simplecrud.urls'
...
WSGI_APPLICATION = 'res_framewrok_simplecrud.wsgi.application'
